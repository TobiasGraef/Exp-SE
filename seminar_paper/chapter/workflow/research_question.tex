...
\begin{table}[]
	...
	\vspace{1em}
	\caption{PICOT criteria adjusted to fit better in computer science research., \todo{replace with graphics}}
	\label{table:PICOT}
\end{table}
