...
Before you can answer a question the existing studies must be critically appraised. This means checking the study design, study quality, relevance for the research question (or \emph{directness}), as well as consistency between different studies. Figure \ref{fig:critical appraisal} shows a checklist containing the important factors to consider when appraising a study.
...
This list resembles the \emph{GRADE approach}\todo{quote \q{Education and debate Grading quality of evidence and strength of recommendations}}, a grading system for studies that goes beyond simple hierarchies of study types. The GRADE-approach was introduced for medicine and has been used in the software engineering domain \cite{Wohlin2013EvidenceProfile}\todo{\q{Empirical studies of agile software development: A systematic review}}. It is a well-defined method and differentiates between the quality of evidence and the strength of recommendation, hence it is an alternative to the checklist in figure \ref{fig:critical appraisal} (or used to complement it).
